...
static void default_collect_read_tid(Relation relation, ItemPointer tid, TransactionId tuple_xid) {}
static void default_clear_rwset(void) {}
static void default_send_rwset_and_wait(void) {}
...
RemoteXactHook *GetRemoteXactHook(void)
{
